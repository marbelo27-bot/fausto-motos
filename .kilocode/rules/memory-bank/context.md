...
| 2026-02 | Added brand/model dropdown selection to Turnos new motorcycle form using Argentine motorcycle brands from 1970 |
| 2026-02 | Added independent motorcycle creation in Turnos: "🏍️ Nueva Moto" button in header opens modal to create motorcycle without requiring client selection first (like Motos module) |
| 2026-02 | Added new motorcycle brands: CF, QJMOTOR, KOVE, HERO, SIAM, KEEWAY, APPIA, RVM, KELLER, BRAVA, Piaggio |
| 2026-02 | Added category field to Parts: 24 categories (Carrocería, Asiento/tapizado, Portaequipaje, Sliders, Discos embrague, Kit pistón, Juntas motor, Válvulas, Cigüeñal, Árbol levas, Bomba aceite, Bomba agua, Filtros aceite/aire/combustible, Pastillas/discos freno, Bujías, Kit arrastre, Neumáticos, Aceite/líquidos, Batería, Bombillas/faros, Cables, Retenes horquilla) - grouped display and filter in Parts module, inline form in ServiceOrders |
| 2026-02 | Added Category type and CRUD to store: 24 default categories with codes (C, A, P, S, D, K, J, V, B, L, O, W, FA, F, FC, Freno, Buj, R, N, Lub, Bat, Ilum, Cab, RH); auto-generated part codes (e.g., A-0001, C-0002) based on category; Parts module now has "📂 Categorías" button to manage categories (add/edit/delete); part codes displayed in inventory list |
